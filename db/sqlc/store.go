...
type Store interface {
	Querier
	TransferMoneyTx(context.Context, TransferTxParams) (TransferTxResult, error)
}
...
func (store *SQLStore) TransferMoneyTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
